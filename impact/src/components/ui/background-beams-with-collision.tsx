...
export const BackgroundBeamsWithCollision = ({
    ...
    return (
        <div
            ref={parentRef}
            className={cn(
                "min-h-screen relative flex items-center w-full justify-center overflow-hidden bg-gradient-to-br from-[#0D1117] via-[#161B22] to-[#0D1117]",
                className
            )}
        >
            {beams.map((beam) => (
    ...
    return (
        <>
            <motion.div
                ...
                className={cn(
                    "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-yellow-500 via-orange-500 to-transparent",
